...
def inicializar_driver(logger, headless=True):
    ...
    try:
        ...
        if headless:
            ...
            options.add_argument('--disable-gpu')  # Necessário para alguns sistemas Windows
...
def main():
    ...
    try:
        # Inicializar driver
        driver = inicializar_driver(logger, headless=True)
